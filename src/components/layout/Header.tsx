...
export function Header({ isSidebarOpen, onToggleSidebar }: HeaderProps) {
  ...
  return (
    <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-40 smooth-transition">
      <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        {/* 좌측: 햄버거 메뉴 + 로고 */}
        <div className="flex items-center gap-4">
          <button
            onClick={onToggleSidebar}
            className="p-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 lg:hidden smooth-transition"
            aria-label="메뉴 열기/닫기"
          >
